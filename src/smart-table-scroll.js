...
var ScrollableTable = (function () {
    ...
    ScrollableTable.prototype.buildRow = function (idx) {
    };
    ScrollableTable.prototype.reset = function () {
        // Reset or init dom elements and scrolling state// Reset or init dom elements and scrolling state
        this.yPosition = 0;
        this.setHeights();
