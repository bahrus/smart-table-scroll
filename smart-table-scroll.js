(function (f) { if (typeof exports === "object" && typeof module !== "undefined") {
    ...
    return (function e(t, n, r) { function s(o, u) { if (!n[o]) {
        ...
        s(r[o]); return s; })({ 1: [function (require, module, exports) {
                 ...
                 */
                var baseCallback = require('lodash._basecallback'), binaryIndex = require('lodash._binaryindex'), binaryIndexBy = require('lodash._binaryindexby');
                /**
                 ...
                 * Available under MIT license <https://lodash.com/license>
                 */
                var baseIsEqual = require('lodash._baseisequal'), bindCallback = require('lodash._bindcallback'), isArray = require('lodash.isarray'), pairs = require('lodash.pairs');
                 ...
                 * Available under MIT license <https://lodash.com/license>
                 */
                var isArray = require('lodash.isarray'), isTypedArray = require('lodash.istypedarray'), keys = require('lodash.keys');
                /** `Object#toString` result references. */
                var argsTag = '[object Arguments]', arrayTag = '[object Array]', boolTag = '[object Boolean]', dateTag = '[object Date]', errorTag = '[object Error]', numberTag = '[object Number]', objectTag = '[object Object]', regexpTag = '[object RegExp]', stringTag = '[object String]';
                /**
                 ...
                 * Available under MIT license <https://lodash.com/license>
                 */
                var getNative = require('lodash._getnative'), isArguments = require('lodash.isarguments'), isArray = require('lodash.isarray');
                ...
                var ScrollableTable = function (opts) {
                    if (!opts.el) {
                        throw new Error("Need to pass `el` into ScrollableTable.");
                    }
                    if (!opts.data) {
                        throw new Error("Need to pass `data` into ScrollableTable.");
                    }
                    if (!opts.buildRow) {
                        throw new Error("Need to pass `buildRow` into ScrollableTable.");
                    }
                    if (!opts.updateRow) {
                        throw new Error("Need to pass `updateRow` into ScrollableTable.");
                    }
                ...
                ScrollableTable.prototype.updateVisibleRows = function (evt) {
                    ...
                    var screenMidpoint = this.el.scrollTop + (this.el.clientHeight / 2), midNdx = _sortedIndex(this.tops, screenMidpoint), freeSearchNdx = 0, fillStart = Math.max(0, midNdx - Math.ceil(this.availableNodes / 2)), fillEnd = Math.min(this.data.length, midNdx + Math.ceil(this.availableNodes / 2));
                    if (this.lastMidNdx === midNdx) {
                    ...
                    for (var rowNdx = fillStart; rowNdx < fillEnd; rowNdx++) {
                        if (!this.data[rowNdx].__node) {
                            while (this.rowsWithNodes[freeSearchNdx] > fillStart &&
                                this.rowsWithNodes[freeSearchNdx] < fillEnd) {
                                freeSearchNdx++;
                            }
...
//# sourceMappingURL=smart-table-scroll.js.map